...
function Sidebars() {
    return (
        ...
        <>
            <button className="btn btn-outline-primary sm" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">Contact us</button>

            <div className="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
                <div className="offcanvas-header">
                    <h4 id="offcanvasRightLabel" className="text-light">Organics World</h4>
                    <button type="button" className="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                </div>
                <div className="offcanvas-body">
                    <div class="container px-2 py-3" id="icon-grid">
                        <h2 className="pb-2 border-bottom text-primary">Contact at</h2>
                        <div className="container d-flex p-4">
                            <ul className="navbar-nav flex-colum flex-wrap ">
                                ...
                                <li className="nav-item col-6 col-md-auto">
                                    <Link className="nav-link p-2" to="$"  rel="noopener">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" className="bi bi-phone" viewBox="0 0 16 16">
                                            <path d="M11 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h6zM5 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H5z" />
                                            <path d="M8 14a1 1 0 1 0 0-2 1 1 0 0 0 0 2z" />
                                        </svg>
                                        <medium> 0123456789</medium>
